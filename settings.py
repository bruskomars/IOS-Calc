...
MATH_POSITIONS = {
    '/': {'col':3, 'row':2, 'character':'', 'operator':'/', 'image path': {'light': 'images/divide2.png', 'dark':'images/divide.png'}},
...
OPERATORS = {
    ...
    'invert': {'col':1, 'row':2, 'text': '', 'image path': {'light': 'images/plus-minus2.png', 'dark':'images/plus-minus.png'}},
